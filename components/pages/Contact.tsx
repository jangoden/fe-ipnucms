...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative isolate bg-gray-50 py-20 sm:py-28">
      {/* Efek glow di background */}
      <div className="absolute inset-x-0 bottom-0 -z-10 h-1/2 bg-white" />
      <div className="absolute inset-x-0 top-0 -z-10 h-1/2 bg-gray-50" />
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div className="pt-8" data-aos="fade-right">
            ...
            <h2 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 md:text-4xl">
              Terhubung dengan PC IPNU Ciamis
            </h2>
            <p className="mt-4 text-lg text-gray-600">
              Kami senang mendengar dari Anda. Silakan isi form di samping atau hubungi kami melalui informasi kontak di bawah ini.
            </p>
            <div className="mt-10 space-y-6 text-gray-700">
              <div className="flex items-center gap-4">
                <PhoneIcon className="h-6 w-6 flex-shrink-0 text-emerald-500" />
                <a href="tel:+6281234567890" className="hover:text-emerald-600">
                  (+62) 812-3456-7890
                </a>
              </div>
              <div className="flex items-center gap-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <span>Jl. Raya Ciamis No. 123, Ciamis, Jawa Barat 46211</span>
              </div>
            </div>
          </div>
