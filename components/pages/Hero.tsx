    ...
    >
      <div className="mx-auto w-full lg:max-w-7xl px-5 sm:px-10 md:px-12 lg:px-5 h-full flex flex-col">
        <div className="flex flex-col h-full lg:grid lg:grid-cols-2 lg:gap-x-12 lg:items-center">
          {/* TEKS */}
                    <div className="order-1 flex flex-col items-center space-y-6 text-center lg:self-center lg:items-start lg:text-left pt-12 pb-2 lg:py-0">
                      <h1 className="w-full font-bold">
                        ...
                        <span className="mt-2 block text-3xl font-bold uppercase text-emerald-800 md:text-4xl lg:text-5xl lg:whitespace-nowrap [font-family:'Bebas Neue'] leading-none">
                          Pimpinan Cabang
                        </span>
                        ...
                        <span
                          className="
                            mt-2 block 
                            text-3xl leading-none sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl
                            text-emerald-800
                        ...
                        <span className="mt-4 block text-2xl font-bold uppercase sm:text-3xl md:text-4xl lg:text-5xl [font-family:'Bebas Neue'] leading-none">
