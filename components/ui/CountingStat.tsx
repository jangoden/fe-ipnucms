...
const CountingStat: React.FC<CountingStatProps> = ({ value, duration = 2000, delay = 0 }) => {
  ...
  useEffect(() => {
    ...
    const animateCount = (timestamp: number) => {
      ...
      if (progress < duration) {
        ...
        // Ensure final value is exactly targetValue, then append non-numeric parts
  ...
  return (
    <span ref={ref}>
      {formattedCount}{nonNumericSuffix}
    </span>
  );
};
